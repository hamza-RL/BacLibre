# Bac Libre — Plateforme de révision (Sciences Physiques)
...
**Fais des sauvegardes régulières** : va dans Réglages → "Télécharger une sauvegarde" pour exporter un fichier `.json`, à garder dans ton Drive. Si tu changes d'appareil ou si tu effaces les données du navigateur, utilise "Restaurer une sauvegarde" avec ce fichier pour tout récupérer.
